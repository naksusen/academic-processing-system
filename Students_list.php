...
<body class="bg-fixed bg-no-repeat bg-cover bg-center bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#f3f4f5] via-[#e0e8ed] to-[#d0dde6]">
  ...
  <div >
        ...
        <aside>
          ...
          $sql = "SELECT DISTINCT program from tbl_students";
        ...
        <!--/form-->
          ...
          $sql = "SELECT DISTINCT year_lvl from tbl_students";
          $result = $conn-> query($sql);
        ...
        <div class="flex flex-col items-center">
          ...
          <?php  
                  if (isset($_GET['order'])){
                    $sql = "SELECT stud_num, year_lvl, program, last_n, first_n, mid_n, contactno, email from tbl_students ORDER BY last_n $sort_order LIMIT $limitStart, $rowsPerPage";
                  }
                  else if (isset($_GET['progvalue'])){
                    $sql = "SELECT stud_num, year_lvl, program, last_n, first_n, mid_n, contactno, email from tbl_students WHERE program = '$program' LIMIT $limitStart, $rowsPerPage";
                  }
                  else if (isset($_GET['yrsec'])){
                    $sql = "SELECT stud_num, year_lvl, program, last_n, first_n, mid_n, contactno, email from tbl_students WHERE year_lvl = '$yrsec' LIMIT $limitStart, $rowsPerPage";
                  }
                  else if (isset($_GET['order']) && isset($_GET['progvalue'])) {
                    $sql = "SELECT stud_num, year_lvl, program, last_n, first_n, mid_n, contactno, email from tbl_students WHERE program = '$program' ORDER BY reqtype $sort_order LIMIT $limitStart, $rowsPerPage";
                  }
                  else {
                    $sql = "SELECT stud_num, year_lvl, program, last_n, first_n, mid_n, contactno, email from tbl_students LIMIT $limitStart, $rowsPerPage";
                  }
