...
if(isset($_POST['completed']))
{
    ...
    $complquery_run  = mysqli_query($conn, "INSERT INTO completed_request (fullname, student_num, yr_sec, program, reqtype) VALUES ('$fullname','$student_num','$yr_sec','$program','$reqtype')");
...
if(isset($_POST['miss']))
{
    ...
    $missquery_run  = mysqli_query($conn, "INSERT INTO missed_request (fullname, student_num, yr_sec, program, reqtype) VALUES ('$fullname','$student_num','$yr_sec','$program','$reqtype')");
...
if(isset($_POST['reject']))
{
    ...
    $mid_n = $row['mid_n'];
    $last_n = $row['last_n'];
    $fullname = $first_n . ' ' . $mid_n . ' ' . $last_n;
    $student_num = $row['stud_num'];
    $year_lvl = $row['year_lvl'];
    $program = $row['program'];
    $reqtype = 'Enrollment Rejection';

    $missquery_run  = mysqli_query($conn, "INSERT INTO missed_request (fullname, student_num, yr_sec, program, reqtype) VALUES ('$fullname','$student_num','$year_lvl','$program','$reqtype')");
