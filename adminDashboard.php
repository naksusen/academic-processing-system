            ...
            >
              ...
              <div class="flex items-stretch gap-5">
                ...
                >
                  ...
                  $sql2="SELECT * FROM `completed_request`";
                  $result2=mysqli_query($conn,$sql2);
                  
                  $count1 = ($result1) ? mysqli_num_rows($result1) : 0;
                  $count2 = ($result2) ? mysqli_num_rows($result2) : 0;
                  echo $count1 + $count2;
                  ?>
                  </div>
                </div>
...
<script>
  firebase.auth().onAuthStateChanged((user) => {
    if (user) {
      ...
      // User is signed out - for development, allow access without authentication
      console.log("User not authenticated - allowing access for development");
      // window.location.href = 'index.html'  // Commented out for development
    }
  });
</script>
